...
Install the **unlocked package** directly — no cloning or building required. Current version: **1.2.0** (`04tOb000002JelNIAS`; maintainers: see [docs/PUBLISHING.md](docs/PUBLISHING.md) to release a new one).
