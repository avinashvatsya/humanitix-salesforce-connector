...
import HumanitixSetupDashboard from 'c/humanitixSetupDashboard';
...
describe('c-humanitix-setup-dashboard', () => {
  afterEach(() => {
  ...
  it('renders the Run Sync Now button when sync is enabled', async () => {
    const element = createElement('c-humanitix-setup-dashboard', { is: HumanitixSetupDashboard });
