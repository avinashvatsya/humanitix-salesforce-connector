...
OBJECTS["Humanitix_Metadata_Deploy__c"] = dict(
    ...
    enableSearch=False,
    fields=[
        dict(api="Deploy_Job_Id__c", type="text", length=64, externalId=True, unique=True,
             label="Deploy Job Id",
             helpText="Tracking token generated by HumanitixMetadataWriter when it enqueues a metadata deployment."),
